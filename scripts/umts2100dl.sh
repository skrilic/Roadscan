...
python gpspectrum.py -g off -p /dev/ttyUSB0 -d data/umts2100dl -c umts2100dl -t 10 -s 3
...
python gpspectrum.py -g $gpsport -p /dev/ttyUSB0 -d data/umts2100dl -c umts2100dl -t $timesec -s 0.5
