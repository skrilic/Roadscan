...
python gpspectrum.py -g off -p /dev/ttyUSB0 -d /home/slaven/Documents/avioband -c aviovhf -t 10 -s 3
...
python gpspectrum.py -g $gpsport -p /dev/ttyUSB0 -d /home/slaven/Documents/avioband -c aviovhf -t $timesec -s 2
