...
python gpspectrum.py -g off -p /dev/ttyUSB0 -d data/gsm1800ul -c gsm1800ul -t 10 -s 3
...
python gpspectrum.py -g $gpsport -p /dev/ttyUSB0 -d data/gsm1800ul -c gsm1800ul -t $timesec -s 2
