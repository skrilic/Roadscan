...
python gpspectrum.py -g off -p /dev/ttyUSB0 -d data/umts2100ul -c umts2100ul -t 10 -s 3
...
python gpspectrum.py -g $gpsport -p /dev/ttyUSB0 -d data/umts2100ul -c umts2100ul -t $timesec -s 0.5
