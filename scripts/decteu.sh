...
python gpspectrum.py -g off -p /dev/ttyUSB0 -d /home/slaven/Documents/decteu -c decteu -t 10 -s 3
...
python gpspectrum.py -g $gpsport -p /dev/ttyUSB0 -d /home/slaven/Documents/decteu -c decteu -t $timesec -s 0.5
