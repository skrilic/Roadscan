...
python gpspectrum.py -g off -p /dev/ttyUSB0 -d data/gsm900ul -c gsm900ul -t 10 -s 3
...
python gpspectrum.py -g $gpsport -p /dev/ttyUSB0 -d data/gsm900ul -c gsm900ul -t $timesec -s 2
